...
export default function MomBabyProductGrid({ products }: MomBabyProductGridProps) {
  ...
  const discountMoney = (p: MomBabyProduct) => (p.originalPrice ? Math.max(0, parseInt(p.originalPrice) - parseInt(p.price)) : 0);
            ...
            <div key={p.id} className="bg-white rounded-xl overflow-hidden shadow-md border">
              ...
              <div className="px-4 pb-4">
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-xs bg-pink-600 text-white px-3 py-1 rounded-full">Mẹ và Bé</span>
                </div>
