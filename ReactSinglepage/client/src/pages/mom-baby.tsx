...
export default function MomBabyPage() {
  ...
  const categories = [
    { label: "Chăm sóc em bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192839-0-P20532_1.png" },
    { label: "Sản phẩm dành cho mẹ", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192726-0-P17661_1_l.png" },
  ];
